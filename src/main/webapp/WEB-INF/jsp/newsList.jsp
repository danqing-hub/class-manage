    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="title" id="stitle" autocomplete="off" class="layui-input layui-input-inline"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="content" id="scontent" autocomplete="off" class="layui-input layui-input-inline"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="startTime" id="endTime" readonly="readonly"
                       class="layui-input layui-input-inline"
                       placeholder="yyyy-MM-dd" style="height: 30px;border-radius: 10px">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="opername" id="sopername" class="layui-input layui-input-inline"
...
<script>
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate', 'layedit'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${pageContext.request.contextPath}/news/getNews.action' //数据接口
           , method: "POST",
            where: {
                content : null
            }
        ...
        $("#doSearch").click(function () {
            ...
            var opername=$("#sopername").val();
            var content=$("#scontent").val();
            var starttime=$("#startTime").val();
            var endtime=$("#endTime").val();
            //alert(params);
            tableIns.reload({
                url: "${pageContext.request.contextPath}/news/getNews.action",
                where:{
                    title:title,
                    opername:opername,
                    content:content,
        ...
        function openUpdateNews(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    url = "${pageContext.request.contextPath}/news/editNews.action";
                }
            });
        }
